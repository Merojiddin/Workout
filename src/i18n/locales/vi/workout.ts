...
export const workoutMessages = {
  ...
  'workout.planLibrary': 'Các kế hoạch tập luyện',
  'workout.plansForLocation': 'Kế hoạch {location} ({count})',
  'workout.choosePlan': 'Chọn kế hoạch',
  'workout.addPlan': 'Thêm kế hoạch',
  'workout.closeAddPlan': 'Đóng',
  'workout.planLibraryHint': 'Chọn kế hoạch đã lưu hoặc thêm kế hoạch mới. Mỗi địa điểm ghi nhớ lựa chọn của bạn.',
  'workout.noPlanForLocation': 'Chọn kế hoạch {location} ở trên hoặc thêm một kế hoạch để bắt đầu.',
  'workout.finishBeforeSwitch': 'Hoàn thành hoặc bỏ buổi tập đang tạm dừng trước khi đổi kế hoạch.',
  'workout.planSwitchFailed': 'Không thể đổi kế hoạch. Kế hoạch hiện tại vẫn được lưu. Vui lòng thử lại.',
  'workout.switchingPlan': 'Đang đổi kế hoạch…',
  'workout.loadingPlanForm': 'Đang tải biểu mẫu kế hoạch…',
