...
export const workoutMessages = {
  ...
  'workout.planLibrary': 'Workout plans',
  'workout.plansForLocation': '{location} plans ({count})',
  'workout.choosePlan': 'Choose a plan',
  'workout.addPlan': 'Add plan',
  'workout.closeAddPlan': 'Close',
  'workout.planLibraryHint': 'Choose a saved plan or add another. Each location remembers your choice.',
  'workout.noPlanForLocation': 'Choose a {location} plan above, or add one to get started.',
  'workout.finishBeforeSwitch': 'Finish or discard your paused workout before switching plans.',
  'workout.planSwitchFailed': 'Could not switch plans. Your current plan is still saved. Please try again.',
  'workout.switchingPlan': 'Switching plan…',
  'workout.loadingPlanForm': 'Loading plan form…',
