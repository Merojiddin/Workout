...
const workoutIdToLibraryId: Record<string, string> = {
  ...
  'alternating-standing-knee-raise': 'standing-knee-raise',
  'low-impact-jumping-jacks': 'low-impact-jumping-jack',
  'modified-jumping-jack': 'low-impact-jumping-jack',
  ...
  'indoor-easy-swimming': 'easy-indoor-swimming',
  ...
  'body-weight-step-up': 'bodyweight-step-up',
  'step-up-bodyweight': 'bodyweight-step-up',
  'incline-pushup': 'incline-push-up',
  'bench-push-up': 'incline-push-up',
  'bird-dog-pause': 'bird-dog-with-pause',
  ...
  'alternating-standing-punches': 'standing-punches',
  'bodyweight-reverse-lunges': 'bodyweight-reverse-lunge',
  'body-weight-reverse-lunge': 'bodyweight-reverse-lunge',
  'standing-elbow-to-knee': 'standing-knee-to-elbow',
  'standing-knee-to-elbows': 'standing-knee-to-elbow',
  ...
  'seated-calf-raise-machine': 'seated-calf-machine-raise',
